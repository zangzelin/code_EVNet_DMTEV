...
# {
# 'pca_extractor': {'NMI': {10: 0.35793698040792077}, 'ACC': {10: 0.4008101851851852}, 'MSELR': {10: 0.0025519966147840023}, 'MSE': {10: 0.002855994738638401}, 'CLASS': {10: 0.41435185185185186}, 'CLASSDT': {10: 0.9768518518518519}}, 
# 'autoencoder': {'NMI': {10: 0.3353430815016417}, 'ACC': {10: 0.38310185185185186}, 'MSELR': {10: 0.003820082638412714}, 'MSE': {10: 0.0036695157177746296}, 'CLASS': {10: 0.3402777777777778}, 'CLASSDT': {10: 0.9907407407407407}}, 'AEFS': {'NMI': {10: 0.23608805279402156}, 'ACC': {10: 0.3162037037037037}, 'MSELR': {10: 0.005642110947519541}, 'MSE': {10: 0.008921600878238678}, 'CLASS': {10: 0.3148148148148148}, 'CLASSDT': {10: 0.9212962962962963}}, 
# 'concrete_column_subset_selector_general': {'NMI': {10: 0.3924433480583588}, 'ACC': {10: 0.4287037037037037}, 'MSELR': {10: 0.0038192232605069876}, 'MSE': {10: 0.004388504661619663}, 'CLASS': {10: 0.4305555555555556}, 'CLASSDT': {10: 0.9861111111111112}}, 
# 'udfs_ours': {'NMI': {10: 0.35265352607913675}, 'ACC': {10: 0.3546296296296296}, 'MSELR': {10: 0.0051062642596662045}, 'MSE': {10: 0.0055589438416063786}, 'CLASS': {10: 0.3645833333333333}, 'CLASSDT': {10: 0.9629629629629629}}, 
# 'mcfs_ours': {'NMI': {10: 0.2303008134381667}, 'ACC': {10: 0.30543981481481486}, 'MSELR': {10: 0.6651079654693604}, 'MSE': {10: 0.9126314520835876}, 'CLASS': {10: 0.29398148148148145}, 'CLASSDT': {10: 0.125}}, 
# 'pfa_transform': {'NMI': {10: 0.1889398535245698}, 'ACC': {10: 0.25983796296296297}, 'MSELR': {10: 0.5296805500984192}, 'MSE': {10: 0.5827653408050537}, 'CLASS': {10: 0.2569444444444444}, 'CLASSDT': {10: 0.1388888888888889}},
#  'random_transform': {'NMI': {10: 0.21740193991716739}, 'ACC': {10: 0.3306712962962962}, 'MSELR': {10: 1.1028236150741577}, 'MSE': {10: 0.6931250691413879}, 'CLASS': {10: 0.3275462962962963}, 'CLASSDT': {10: 0.09259259259259259}}}

from baseline.Concrete_Autoencoders.experiments.concrete_estimator import run_experiment
...
def load_mice(one_hot = False):
    ...
    X = np.genfromtxt('/root/data/feature_select/Data_Cortex_Nuclear.csv', delimiter = ',', skip_header = 1, usecols = range(1, 78), filling_values = filling_value, encoding = 'UTF-8')
    classes = np.genfromtxt('/root/data/feature_select/Data_Cortex_Nuclear.csv', delimiter = ',', skip_header = 1, usecols = range(78, 81), dtype = None, encoding = 'UTF-8')
...
def aefs_subset_selector(train, K, epoch_num=1000, alpha=0.1):
    ...
    batch_size = np.min([train[0].shape[0], 256])
...
def eval_on_dataset(name, train, test, feature_sizes, debug = False):
    ...
    algorithms = [pca_extractor, autoencoder, AEFS, concrete_column_subset_selector_general, udfs_ours, mcfs_ours, pfa_transform, random_transform]
...
def main():
    ...
    for i in range(11, 14):
        ...
        eval_on_dataset('%d_fashion.json' % i, train, test, [10], True)
